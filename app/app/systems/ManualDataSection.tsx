...
function ManualHeaderBlock() {
  return (
    <div>
      <h1 className="text-2xl font-semibold text-white">Ручной ввод данных</h1>
      <p className="mt-1 text-sm text-slate-400">
        Ежедневный ввод: каналы, сайт, продажи, воронка. Отчёты считаются из сохранённых дней.
      </p>
    </div>
  );
}

export function ManualDataSection({ embedded = false }: { embedded?: boolean }) {
