...
export default function AppTopbar() {
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      {/* RIGHT: actions (как у тебя справа) */}
      <div className="flex items-center gap-2">
        <button className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white/80 px-3 py-2 text-xs font-medium text-neutral-800 hover:bg-white">
          <FileText className="h-4 w-4" />
          Фактура бизнеса
        </button>

        <button className="inline-flex items-center gap-2 rounded-full bg-neutral-900 px-3 py-2 text-xs font-semibold text-white hover:bg-neutral-800">
